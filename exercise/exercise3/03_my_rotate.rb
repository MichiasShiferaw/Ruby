...
def my_rotate!(array, amt)
    ...
    # end
    # #array.each_with_index{|value, ind| newArray[(ind+(-1)*amt)%array.length]=value }
    # (0...array.length).each_with_index do |ind|
    #     #newArray[(ind+(-1)*amt)%array.length]=nil
    #     newArray[(ind+(-1)*amt)%array.length]=array[ind]
